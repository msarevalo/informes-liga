...
<div style="margin-left: 350px">
    ...
    <form action="../back/cargar-pospago.php" style="margin-left: 100px" enctype="multipart/form-data" method="post" id="crear" style="padding: 30px">
        ...
        <button class="btn w-M br-0 stl-3" href="usuarios.php">Cargar Pospago</button>
    </form>
